...
@Configure(storyLoader = Prouni.StoryLoader.class, storyReporterBuilder = Prouni.ReportBuilder.class)
...
@UsingSteps(instances = { ProuniSteps.class })
public class Prouni extends InjectableEmbedder {
	...
	public static class StoryLoader extends LoadFromClasspath {
		public StoryLoader() {
			super(Prouni.class.getClassLoader());
		}
	}
